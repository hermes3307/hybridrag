#!/usr/bin/env python3
"""
Enhanced Web-based Face Processing GUI
Complete system with batch download, vector database, and search functionality
"""
...
class EnhancedConfig:
    """Enhanced configuration with vector database support"""
    def __init__(self):
...
class VectorDatabase:
    ...
    def initialize(self):
        ...
        try:
            ...
            self.embeddings_count = self.collection.count()
        ...
        try:
            if PIL_AVAILABLE:
                with Image.open(image_path) as img:
                    # Convert to numpy array and create statistical embedding
                    ...
                    if len(img_array.shape) == 3:
                        ...
                        features = [
                            float(np.mean(flat_img)),
                            float(np.std(flat_img)),
                            float(np.median(flat_img))
                        ]
    ...
    def search_similar(self, query_path, n_results=5):
        ...
        try:
            ...
            results = self.collection.query(
                ...
                n_results=min(n_results, self.embeddings_count)
            )
    ...
    def get_stats(self):
        ...
        if self.initialized:
            try:
                ...
                self.embeddings_count = stats['collection_count']
            except:
                pass
...
class EnhancedDownloader:
    ...
    def download_batch(self, count, progress_callback=None):
        ...
        for i in range(count):
            ...
            if progress_callback:
                progress_callback(i + 1, count, successful, failed)
...
<head>
    ...
    <script>
        ...
        function downloadBatch() {
            ...
            document.getElementById('batch-download-btn').textContent = 'Downloading...';
            ...
            fetch(`/api/batch_download?count=${count}`)
                ...
                .finally(() => {
                    ...
                    document.getElementById('batch-download-btn').textContent = 'Start Batch Download';
                });
        }
        ...
        function processAllFaces() {
            ...
            fetch('/api/process_all')
                ...
                .finally(() => {
                    ...
                    document.getElementById('process-btn').textContent = 'Process All Faces';
                });
        }
        ...
        function searchSimilar() {
            ...
            // For demo, we'll search using the first available file
            ...
            results.forEach((result, index) => {
                ...
                div.innerHTML = `
                    <div class="result-info">
                        ...
                        Distance: ${result.distance.toFixed(3)}<br>
...
<body>
    <div class="container">
        <header>
            ...
            <p>Complete Web Interface with Vector Database & Search</p>
        </header>
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <div class="control-section">
                    ...
                    <div class="input-group">
                        <label for="batch-count">Number of faces:</label>
                        <input type="number" id="batch-count" min="1" max="100" value="5">
                    </div>
            ...
            <div class="card">
                ...
                <div class="stats">
                    <div class="stat">
                        <label>ChromaDB Available:</label>
                    ...
                    <div class="stat">
                        ...
                        <span id="db-path">./chroma_db</span>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="search-controls">
                    <div class="input-group">
                        <label for="search-file">Search image:</label>
                    ...
                    <button class="btn btn-primary" onclick="searchSimilar()">
            ...
            <div class="card">
                ...
                <div class="info">
                    ...
                    <p><strong>ChromaDB available:</strong> """ + ("✅ Yes" if CHROMADB_AVAILABLE else "❌ No") + """</p>
                    <p><strong>Faces directory:</strong> ./faces</p>
                    <p><strong>Source:</strong> ThisPersonDoesNotExist.com</p>
                    <p><strong>Embedding dimensions:</strong> 128</p>
                </div>
            </div>
        </div>

        <footer>
            <p>Enhanced Face Processing System - Complete Web Interface</p>
        </footer>
    </div>
</body>
</html>
    ...
    def serve_search(self, query):
        ...
        # For demo, search using the first available image
...
class EnhancedWebServer:
    """Enhanced web server with full functionality"""
    ...
    def start(self):
        ...
        print("=" * 60)
        print("🌐 ENHANCED FACE PROCESSING WEB INTERFACE")
        print("=" * 60)
        ...
        print(f"🔍 Vector database: {'✅ Initialized' if self.vector_db.initialized else '❌ Not available'}")
        print()
        print("📖 Features:")
        print("   • Single and batch face downloading")
